...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/pages/EditorFlow/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/pages/user/login/locales/en-US.ts')),
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/pages/EditorFlow/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/pages/user/login/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/locales/zh-TW.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/ReactAntdCom_Code/2020.1.17/src/pages/user/login/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
